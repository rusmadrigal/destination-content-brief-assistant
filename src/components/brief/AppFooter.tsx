    ...
    <footer className="mt-12 border-t border-slate-200 bg-white py-6">
      <div className="mx-auto max-w-7xl px-4 text-xs text-slate-500 sm:px-6 lg:px-8">
        <div className="max-w-xl space-y-2">
          <p className="font-medium text-granicus-navy">Granicus Destinations · Internal tool</p>
          <p>
            Form data may be sent to OpenAI when AI enhancement is enabled and{" "}
            <code className="rounded bg-slate-100 px-1 text-granicus-navy">OPENAI_API_KEY</code> is set. Do not
