...
export interface InternalLinkRecommendation {
  ...
  link: string;
  /** Whether this came from user input, site crawl, inferred site URLs, or a generated category suggestion. */
  source: "provided" | "discovered-url" | "suggested-url" | "suggested-category";
  placement: string;
}
